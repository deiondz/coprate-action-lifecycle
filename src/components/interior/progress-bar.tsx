...
export function ProgressBar({
	...
	return (
		<div className={`w-full ${className}`}>
			...
			>
				<div className="relative h-2 overflow-hidden rounded-[2px]">
					<motion.span
						aria-hidden
						className="absolute inset-0 block origin-left rounded-[2px] bg-[#4568FF] shadow-[inset_0_1px_0_rgba(255,255,255,0.35),inset_0_-1px_0_rgba(28,25,23,0.2)] dark:bg-[#93B0FF]"
						initial={false}
					...
					{indeterminate && !reduced ? (
						<motion.span
							aria-hidden
							className="absolute inset-y-0 left-0 block w-2/5 rounded-[2px] bg-[#4568FF] dark:bg-[#93B0FF]"
